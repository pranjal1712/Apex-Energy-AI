    ...
    <aside className={`sidebar-container ${isOpen ? 'open' : ''}`}>
      ...
      <div className="sidebar-header">
        <div className="flex items-center gap-3">
          <div className="logo-brand-container" style={{ width: '48px', height: '48px', padding: '4px' }}>
            <img src="/logo.png" alt="Logo" className="logo-brand-img" />
          </div>
          <span className="sidebar-brand-name">Apex Energy <span className="text-energy">AI</span></span>
        </div>
