  ...
  return (
    <div className="upload-page-wrapper">
      <div className="absolute top-6 left-8 flex items-center gap-3">
        <div className="logo-brand-container" style={{ width: '48px', height: '48px', padding: '0px' }}>
          <img src="/logo.png" alt="Logo" className="logo-brand-img" />
        </div>
        <span className="text-xl font-bold text-white tracking-widest opacity-80 uppercase">APEX ENERGY AI</span>
      </div>
