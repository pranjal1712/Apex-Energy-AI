    ...
    <div className="auth-premium-card auth-sync-height">
      <div className="auth-glow-header pt-12">
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="text-2xl font-bold tracking-tight text-white">Apex Energy AI</span>
        </div>
      ...
      <div className="p-8">
        ...
        {isVerifying ? (
          ...
          <>
            ...
            <form onSubmit={handleSignup} className="space-y-6">
              <div>
                <label className="label-premium">Username <span className="text-[#a855f7]">*</span></label>
                <input
                  type="text"
                  required
                  value={username}
              ...
              <div>
                <label className="label-premium">E-mail Address <span className="text-[#a855f7]">*</span></label>
                <input
                  type="email"
                  required
                  value={email}
              ...
              <div>
                <label className="label-premium">Password <span className="text-[#a855f7]">*</span></label>
                <input
                  type="password"
                  required
                  value={password}
              ...
              <button
                type="submit"
                disabled={loading}
                className="premium-btn-accent flex items-center justify-center mt-4 shadow-[0_0_20px_rgba(168,85,247,0.2)] py-5 text-lg"
              >
        ...
        <p className="mt-10 text-center text-sm text-gray-500 font-bold">
          ...
          <Link to="/login" className="text-[#a855f7] font-bold hover:brightness-125 transition-all">
            Sign In
          </Link>
        </p>
      </div>
