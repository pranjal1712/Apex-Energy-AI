    ...
    <div className="auth-premium-card auth-sync-height">
      ...
      <div className="p-8">
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <Link to="/forgot-password" rounded-none className="text-xs font-bold text-[#a855f7] hover:brightness-125 transition-all">
                Forgot Password?
              </Link>
            </div>
            <input
          ...
          <div className="flex items-center gap-3 py-2">
            <input type="checkbox" className="w-5 h-5 rounded border-white/10 bg-black/50 accent-[#a855f7]" id="remember" />
        ...
        <p className="mt-10 text-center text-sm text-gray-500 font-bold">
          ...
          <Link to="/signup" className="text-[#a855f7] font-bold hover:brightness-125 transition-all">
            Sign Up
          </Link>
        </p>
      </div>
