    ...
    <div className="auth-premium-card">
      ...
      <div className="p-12">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div>
            <label className="label-premium">Email Address <span className="text-[#a855f7]">*</span></label>
            <input
              type="email"
              required
              value={email}
          ...
          <button
            type="submit"
            disabled={loading}
            className="premium-btn-accent w-full flex items-center justify-center shadow-[0_0_20px_rgba(168,85,247,0.2)] py-5 text-lg"
          >
