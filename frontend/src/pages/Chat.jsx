...
import { Send, LogOut, FileText, File, ArrowRight, Plus, Upload as UploadIcon, Loader2, Menu, MoreVertical, Settings, Sparkles, Mic, ChevronDown } from 'lucide-react';
            ...
            if (metaMatch) {
              try {
                ...
                setMessages(prev => {
                  ...
                  next[next.length - 1] = { 
                    ...next[next.length - 1], 
                    sources: metadata.chunks,
                    isAgentic: metadata.is_agentic,
      ...
      <main className="main-chat">
        ...
        <header className="mobile-header">
          <button className="mobile-brand-btn" onClick={() => setIsMobileSidebarOpen(true)}>
            ...
            <span>Apex Energy <span className="text-energy">AI</span></span>
          </button>
          ...
          <div className="mobile-menu-container">
            ...
            {isMobileMenuOpen && (
              <>
                ...
                <div className="mobile-menu-dropdown glow-purple">
                    ...
                    <>
                      ...
                      {msg.suggestions && msg.suggestions.length > 0 && (
                        <div className="mt-6 pt-4 border-t border-white/5">
                          <p className="text-[10px] uppercase tracking-widest font-bold text-white/30 mb-3">Suggested Investigations</p>
                          <div className="flex flex-wrap gap-2">
                            {msg.suggestions.map((q, idx) => (
                              <button 
                                key={idx}
                                onClick={() => { setInput(q); }}
                                className="px-3 py-2 bg-white/5 hover:bg-energy/10 border border-white/10 hover:border-energy/30 rounded-lg text-xs text-white/70 hover:text-energy transition-all"
                              >
                                {q}
                              </button>
                            ))}
